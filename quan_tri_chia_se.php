      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Quản trị chia sẻ</h3>
                </div>
          ...
          <div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Danh sách các user</h4>
                  <p class="card-description">
                   <button type="button" class="btn btn-primary btn-sm"><a href="chia_se_them_moi.php" style="color: white; text-decoration: none">Thêm mới</a></button>
                  </p>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <?php
                                    ...
                                    $i=0;
                                    while ($row = mysqli_fetch_array($noi_dung_chia_se))
                                        {
                                            $i++;
                                            ;?>
                                        ...
                                        <tr class="table-info">
                                            ...
                                            <td><?php echo $row["nghe_nghiep"] ;?></td>
                                            <td><?php echo $row["loi_nhan"] ;?></td>
                                            <td><a href="chia_se_sua.php?id=<?php echo $row['id_chia_se'];?>">Sửa</a></td>
                                            <td><a href="chia_se_xoa.php?id=<?php echo $row['id_chia_se'];?>">Xóa</a></td>
                                        </tr>
                                        <?php }
