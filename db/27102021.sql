...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 27, 2021 lúc 06:22 AM
...
(6, 'tt', 'thuhak22ba@gmail.com', '', '0906235350', 'img/', 'Ai Cáº­p');
...
(3, 'Bùi Thu Hà', '0367997052', 'thuhak22ba@gmail.com', 'Quần áo, giày dép', '2021-10-27 00:00:00', 'Công khai', 2),
(4, 'BÃ¹i Thu HÃ ', '0367997052', 'thuhak22ba@gmail.com', 'Äá»“ dÃ¹ng há»c táº­p', '2021-10-27 00:00:00', 'CÃ´ng khai', 5);
...
(2, '2021-10-27 00:00:00', 'BÃ¹i Thu HÃ ', '0367997052', 'thuhak22ba@gmail.com', 5000000, 'img/anhxn/kq2.jpg', 'CÃ´ng khai', 11, 1);
...
--
ALTER TABLE `tbl_ungho_vatchat`
  MODIFY `id_vat_chat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `tbl_ung_ho_da_xn`
--
ALTER TABLE `tbl_ung_ho_da_xn`
  MODIFY `id_xn` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `tbl_ung_ho_tien`
--
ALTER TABLE `tbl_ung_ho_tien`
  MODIFY `id_ung_ho` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
