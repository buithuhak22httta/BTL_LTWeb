...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 25, 2021 lúc 04:49 PM
...
ALTER TABLE `tbl_tham_gia`
  ADD PRIMARY KEY (`id_tham_gia`),
  ADD KEY `id_su_kien` (`id_su_kien`),
  ADD KEY `id_tnv` (`id_tnv`);
...
--
ALTER TABLE `tbl_tham_gia`
  MODIFY `id_tham_gia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
