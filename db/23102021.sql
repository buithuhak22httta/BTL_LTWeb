...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 23, 2021 lúc 05:52 PM
...
(7, '<p>Táº¥m gÆ°Æ¡ng s&aacute;ng</p> ', '<p>Em L&ugrave;i Thá»‹ M&iacute;a má»™t há»c sinh ngh&egrave;o táº¡i khu vá»±c miá»n n&uacute;i kh&oacute; khÄƒn nháº¥t tá»‰nh SÆ¡n La. Ä&atilde; xuáº¥t sáº¯c Ä‘á»— trÆ°á»ng Há»c viá»‡n Ng&acirc;n H&agrave;ng nhÆ°ng ho&agrave;n cáº£nh kh&oacute; khÄƒn, em kh&ocirc;ng Ä‘á»§ Ä‘iá»u kiá»‡n tá»›i trÆ°á»ng. Nhá» sá»± gi&uacute;p Ä‘á»¡ cá»§a quá»¹ há»c bá»•ng HELPV em Ä‘&atilde; c&oacute; cÆ¡ há»™i tiáº¿p tá»¥c con Ä‘Æ°á»ng há»c táº­p v&agrave; gi&agrave;nh nhiá»u th&agrave;nh t&iacute;ch cao trong há»c táº­p.&nbsp;</p>', 'img/blog-1.jpg'),
(8, '<p>Tr&aacute;i tim trá»Ÿ láº¡i</p> ', '<p>Em La Pu S&aacute; bá»‹ máº¯c bá»‡nh tim báº©m sinh, gia Ä‘&igrave;nh ho&agrave;n cáº£nh kh&oacute; khÄƒn kh&ocirc;ng Ä‘á»§ Ä‘iá»u kiá»‡n chá»¯a trá»‹ cho em. C&aacute;c nh&agrave; háº£o t&acirc;m v&agrave; t&igrave;nh nguyá»‡n vi&ecirc;n cá»§a HELPV Ä‘&atilde; t&agrave;i trá»£ v&agrave; gi&uacute;p Ä‘á»¡ táº¡o Ä‘iá»u kiá»‡n cho em Ä‘Æ°á»£c pháº«u thuáº­t th&agrave;nh c&ocirc;ng. Hiá»‡n táº¡i, em Ä‘&atilde; ho&agrave;n to&agrave;n b&igrave;nh phá»¥c.</p>', 'img/blog-2.jpg'),
(9, '<p>Ng&ocirc;i nh&agrave; má»›i</p> ', '<p>Hai anh em VÅ© VÄƒn An v&agrave; VÅ© VÄƒn B&igrave;nh máº¥t Ä‘i cáº£ ngÆ°á»i th&acirc;n láº«n ng&ocirc;i nh&agrave; gáº¯n b&oacute; hÆ¡n 10 nÄƒm sau tráº­n lÅ© lá»¥t nÄƒm 2020. Nhá» quá»¹ M&aacute;i áº¥m cho em cá»§a HELPV, th&aacute;ng 12 nÄƒm 2020 c&aacute;c em Ä‘&atilde; c&oacute; má»™t ng&ocirc;i nh&agrave; má»›i.&nbsp;</p>', 'img/blog-3.jpg');
...
(1, 'Tráº§n Thá»‹ Thá»§y TiÃªn', 'thuytienn2210@gmail.com', 'Ca sÄ©', 'ÄÃ¢y lÃ  má»™t tá»• chá»©c ráº¥t Ã½ nghÄ©a, cáº£m Æ¡n Ä‘á»™i ngÅ© Ä‘Ã£ thá»±c hiá»‡n nhá»¯ng chÆ°Æ¡ng trÃ¬nh giÃºp Ä‘á»¡ tráº» em.'),
(2, 'Nguyá»…n PhÆ°Æ¡ng Háº±ng', 'ntphuonghang@gmail.com', 'Doanh nhÃ¢n', 'HELPV lÃ  má»™t tá»• chá»©c tuyá»‡t vá»i. Cáº£m Æ¡n táº¥t cáº£ cÃ¡c báº¡n.'),
(3, 'VÃµ HoÃ i Linh', 'vohlinh@gmail.com', 'Nghá»‡ sÄ©', 'Tháº­t tuyá»‡t vá»i , cÃ¡c báº¡n Ä‘Ã£ tháº¯p sÃ¡ng thÃªm cho tÆ°Æ¡ng lai cá»§a nhá»¯ng máº§n non Ä‘áº¥t nÆ°á»›c.'),
(4, 'LÆ°u Máº¡nh Tháº¯ng', 'manhthangqnsoft@gmail.com', 'GiÃ¡o viÃªn', 'TÃ´i Ä‘Ã£ trao Ä‘á»•i vá»›i ngÆ°á»i Ä‘á»©ng Ä‘áº§u vÃ  tÃ´i cÃ³ niá»m tin ráº±ng tÃ´i cÃ³ thá»ƒ yÃªn tÃ¢m Ä‘áº§u tÆ° tá»« thiá»‡n vÃ o nÆ¡i ');
...
CREATE TABLE `tbl_ungho_vatchat` (
  ...
  `phanloai` varchar(200) CHARACTER SET utf8 COLLATE utf8_vietnamese_ci NOT NULL,
...
INSERT INTO `tbl_ungho_vatchat` (`id_vat_chat`, `ten`, `sdt`, `email`, `phanloai`, `time`) VALUES
(1, 'Tạ Kim Oanh', '0889577788', 'oanh@gmail.com', 'Quần áo', '2021-10-22 22:42:15');
...
CREATE TABLE `tbl_ung_ho` (
  ...
  `time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ten` varchar(50) CHARACTER SET utf8 COLLATE utf8_vietnamese_ci DEFAULT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `tbl_ung_ho`
--

INSERT INTO `tbl_ung_ho` (`id_ung_ho`, `time`, `ten`, `dien_thoai`, `email`, `so_tien`, `anh_xac_nhan`) VALUES
(1, '2021-10-14 11:59:11', 'Tạ Kim Oanh', '0886630886', 'takimoanh@gmail.com', 30000, NULL),
(2, '2021-10-22 11:59:11', 'Huỳnh Thảo Ly', '0977406604', 'lyhuynh@gmail.com', 4000000, 'img/anhxn/rR28a7k.png'),
(3, '2021-10-24 00:00:00', 'fr', '021546', 'rren@gmail.com', 542366, 'img/anhxn/'),
(4, '2021-10-22 00:00:00', 'Dá»± Ã¡n nuÃ´i em', '021546', 'dt2@gmail.com', 8456213, 'img/anhxn/test.jpg');
...
INSERT INTO `tbl_ung_ho_da_xn` (`id_xn`, `time`, `ten`, `dien_thoai`, `email`, `so_tien`, `anh_xac_nhan`) VALUES
(1, '2021-10-08 00:00:00', 'tt', '0123456', '123a@gmail.com', 5000000, 'img'),
(2, '2021-10-23 22:17:17', 'nhh', '01486', 'nụhe@gmail.com', 600000, 'rrfgf'),
(19, '2021-10-23 22:19:32', 'rttr', '02356', 'jdgdt@gmail.com', 5000000, 'dbjd');
...
--
ALTER TABLE `tbl_ungho_vatchat`
  MODIFY `id_vat_chat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `tbl_ung_ho`
--
ALTER TABLE `tbl_ung_ho`
  MODIFY `id_ung_ho` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT cho bảng `tbl_ung_ho_da_xn`
--
ALTER TABLE `tbl_ung_ho_da_xn`
  MODIFY `id_xn` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
COMMIT;
