...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 28, 2021 lúc 05:37 AM
...
(5, 'BÃ¹i Thu HÃ ', 'thuhak22ba@gmail.com', 'sinh viÃªn', 'Cáº£m Æ¡n má»i ngÆ°á»i', 1);
...
(4, '2021-10-27 00:00:00', 'BÃ¹i Thu HÃ ', '0367997052', 'thuhak22ba@gmail.com', 5000000, 'img/anhxn/veque.jpg', 'CÃ´ng khai', 4, 1);
...
(1, '2021-10-28 00:00:00', 'BÃ¹i Thu HÃ ', '0367997052', 'thuhak22ba@gmail.com', 2000000, 'img/anhxn/kq3.jpg', 'CÃ´ng khai', 5);
...
(1, '2021-10-27', 'BÃ¹i Thu HÃ ', '0367997052', 'thuhak22ba@gmail.com', 'Quáº§n Ã¡o, giÃ y dÃ©p', 'CÃ´ng khai', 4, 1),
(2, '2021-10-28', 'BÃ¹i Thu HÃ ', '0367997052', 'thuhak22ba@gmail.com', 'Thiáº¿t bá»‹ Ä‘iá»‡n tá»­', 'CÃ´ng khai', 5, 1);
...
--
ALTER TABLE `tbl_chia_se_user`
  MODIFY `id_chia_se` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tbl_tham_gia`
  MODIFY `id_tham_gia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `tbl_ung_ho_da_xn`
  MODIFY `id_xn` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `tbl_ung_ho_tien`
--
ALTER TABLE `tbl_ung_ho_tien`
  MODIFY `id_ung_ho` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `tbl_ung_ho_vatchat_da_xn`
--
ALTER TABLE `tbl_ung_ho_vatchat_da_xn`
  MODIFY `id_vc_xn` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
