...
<body>
    <?php
            ...
            if($anh == NULL){
                $sql = "
                    UPDATE `tbl_su_kien` 
                    SET `ten` = '".$ten."', `noi_dung` = '".$noi_dung."', `ngay_to_chuc` = '".$ngay_tc."', `dia_diem` = '".$diadiem."', `thoi_gian` = '".$thoigian."'
                ...
                $sql = "
                    UPDATE `tbl_su_kien` 
                    SET `ten` = '".$ten."', `noi_dung` = '".$noi_dung."', `ngay_to_chuc` = '".$ngay_tc."', `dia_diem` = '".$diadiem."', `thoi_gian` = '".$thoigian."', `image` = 'img/".$anh."'
                    WHERE `tbl_su_kien`.`id_su_kien` = '".$id_su_kien."'
                    ";
            }
