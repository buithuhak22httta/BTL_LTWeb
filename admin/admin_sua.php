            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Cập nhật thông tin admin</h3>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    ...
                    $row = mysqli_fetch_array($noi_dung_admin);
                    
                        ;?>

                    <form class="forms-sample" method="POST" action="admin_sua_thuc_hien.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txtDienThoai" name="txtDienThoai" placeholder="Nhập số điện thoại" value="<?php echo $row['sdt'] ;?>"/>
                    </div>
                    <div class="form-group">
                      <label for="txtDiaChi">Địa chỉ</label>
                      <input type="text" class="form-control" id="txtDiaChi" name="txtDiaChi" placeholder="Nhập địa chỉ" value="<?php echo $row['dia_chi'] ;?>"/>
                    </div>
                    <div class="form-group">
