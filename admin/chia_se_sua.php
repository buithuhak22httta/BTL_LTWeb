            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Cập nhật các user</h3>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    ...
                    $sql = "
                            SELECT * 
                            from tbl_chia_se_user 
                            where id_chia_se = ".$id_chia_se."
                            order by id_chia_se desc";

                    $noi_dung_chia_se = mysqli_query($ket_noi, $sql);

                    $row = mysqli_fetch_array($noi_dung_chia_se);
                    
                        ;?>

                    <form class="forms-sample" method="POST" action="chia_se_sua_thuc_hien.php" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="txtTen">Họ và tên</label>
                      <input type="text" class="form-control" id="txtTen" name="txtTen" placeholder="Nhập họ và tên" value="<?php echo $row['ten'] ;?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txtNgheNghiep" name="txtNgheNghiep" placeholder="Nhập nghề nghiệp" value="<?php echo $row['nghe_nghiep'] ;?>"/>
                    </div>
                    <div class="form-group">
                      <label for="txtLoiNhan">Lời nhắn</label>
                      <input type="text" class="form-control" id="txtLoiNhan" name="txtLoiNhan" placeholder="Viết một lời nhắn" value="<?php echo $row['loi_nhan'] ;?>"/>
                    </div>
                    <div>
                    <input type="hidden" name="txtID" value="<?php echo $row['id_chia_se'];?>">
                    <button type="submit" class="btn btn-primary mr-2">Lưu cập nhật</button>
                    </div>
                  </form>
                  </div>
                </div>
