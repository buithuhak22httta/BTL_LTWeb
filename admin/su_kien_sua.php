            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Cập nhật sự kiện</h3>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    ...
                    $row = mysqli_fetch_array($noi_dung_su_kien);
                    
                        ;?>

                    <form class="forms-sample" method="POST" action="su_kien_sua_thuc_hien.php" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="txtTen">Tên sự kiện</label>
                      <input type="text" class="form-control" id="txtTen" name="txtTen" placeholder="Tên sự kiện" value="<?php echo $row['ten'] ;?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="txtNgay" name="txtNgay" placeholder="Ngày tổ chức" value="<?php echo $row['ngay_to_chuc'] ;?>"/>
                    </div>
                    <div class="form-group">
                      <label for="txtThoiGian">Thời gian</label>
                      <input type="text" class="form-control" id="txtThoiGian" name="txtThoiGian" placeholder="Thời gian" value="<?php echo $row['thoi_gian'] ;?>"/>
                    </div>
                    <div class="form-group">
                      <label for="txtDiaDiem">Địa điểm</label>
                      <input type="text" class="form-control" id="txtDiaDiem" name="txtDiaDiem" placeholder="Địa điểm" value="<?php echo $row['dia_diem'] ;?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div>
                    <input type="hidden" name="txtID" value="<?php echo $row['id_su_kien'];?>">
