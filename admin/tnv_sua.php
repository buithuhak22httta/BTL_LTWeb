            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Cập nhật thông tin tình nguyện viên</h3>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    ...
                    $row = mysqli_fetch_array($tnv);
                    
                        ;?>

                    <form class="forms-sample" method="POST" action="tnv_sua_thuchien.php" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="txtTen">Họ và tên</label>
                      <input type="text" class="form-control" id="txtTen" name="txtTen" placeholder="Họ và tên" value="<?php echo $row['ten_nv'] ;?>"/>
                    </div>
                    <div class="form-group">
                      <label for="txtGioitinh">Giới tính</label>
                      <input type="text" class="form-control" id="txtGioitinh" name="txtGioitinh" placeholder="Giới tính" value="<?php echo $row['gioi_tinh'] ;?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txtGhichu" name="txtGhichu" placeholder="Ghi chú" value="<?php echo $row['ghi_chu'] ;?>"/>
                    </div>
                    <input type="hidden" name="txtId" value="<?php echo $row['id_tnv'];?>">
