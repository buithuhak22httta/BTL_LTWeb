...
<head>
  ...
  <title>Xác nhận ủng hộ vật chất</title>
  <!-- plugins:css -->
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    ...
                    $sql = "
                            SELECT id_vat_chat, tbl_ungho_vatchat.ten, time, email, sdt, phanloai, trang_thai, tbl_su_kien.ten as 'Su_kien', tbl_su_kien.id_su_kien from tbl_ungho_vatchat join tbl_su_kien on tbl_ungho_vatchat.id_su_kien = tbl_su_kien.id_su_kien 
                    ...
                    <form class="forms-sample" method="POST" action="ung_ho_vatchat_xac_nhan_thuc_hien.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label for="txtPL">Phân Loại</label>
                      <input type="text" class="form-control" id="txtPL" name="txtPL" placeholder="Phân Loại" value="<?php echo $row['phanloai'] ;?>"/>
                    </div>
                    <div class="form-group">
